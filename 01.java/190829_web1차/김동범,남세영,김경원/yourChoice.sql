/* CREATE USER */
CREATE USER art IDENTIFIED BY art;
GRANT connect, resource, dba TO art; 
GRANT CREATE ANY DIRECTORY TO art;
GRANT CREATE PROCEDURE TO art;
GRANT CREATE trigger TO art;
